...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        appearance.barTintColor = UIColor(red: 245.2/255.0, green: 168.2/255.0, blue: 20.0/255.0, alpha: 1.0)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Romashka.MyApp" in the application's documents Application Support directory.
